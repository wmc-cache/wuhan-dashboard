<template>
  <main class="more__grid">
    <section class="mod">
      <h3 class="mod__title">数据报表（模拟）</h3>
      <div class="mod__body">
        <div class="cards">
          <div v-for="k in kpis" :key="k.name" class="card">
...
// 假数据：关键指标卡片
const kpis = [
  { name: '当月新增工会', value: 36 },
  { name: '当月新增会员', value: 1897 },
  { name: '重点企业覆盖率', value: '92%' },
  { name: '活动开展次数', value: 128 }
];
</script>
